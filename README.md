...
<h1 align="center">pycodestyle</h1>
  ...
  build:
    ...
    steps:
      ...
      - name: Run Pycodestyle
        run: bash <(curl -s https://raw.githubusercontent.com/lupaxa-cicd-toolbox/pycodestyle/master/src/pipeline.sh)
```
...
```bash
bash <(curl -s https://raw.githubusercontent.com/lupaxa-cicd-toolbox/pycodestyle/master/src/pipeline.sh)
```
